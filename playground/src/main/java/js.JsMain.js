...
j_JsMain_main_Slabyb = $args => {
    ...
    $bar = js_Bar_import.j_Bar__init_0();
    (org_teavm_runtime_import.jl_System_out()).$println_VHLrpW($bar.$foo());
    $baz = js_Baz_import.j_Baz__init_0();
...
j_JsMain_make_VHLrpW = $what => {
    ...
    if ($what.$equals_yToRiJ(org_teavm_runtime_import.$rt_str("Bar")))
        return js_Bar_import.j_Bar__init_0();
    if (!$what.$equals_yToRiJ(org_teavm_runtime_import.$rt_str("Baz")))
        return null;
    return js_Baz_import.j_Baz__init_0();
},
...
j_JsMain$JsMainCtor = org_teavm_runtime_import.$rt_classWithoutFields(0),
...
org_teavm_runtime_import.$rt_metadata([j_JsMain, 0, org_teavm_runtime_import.jl_Object, [], 0, 3, 0, j_JsMain_$callClinit, [(o,r)=>o.$foo=r, org_teavm_runtime_import.$rt_wrapFunction0(j_JsMain_foo), (o,r)=>o.$_init__Wwumam=r, org_teavm_runtime_import.$rt_wrapFunction1(j_JsMain__init__Wwumam)],
j_JsMain$JsMainCtor, 0, org_teavm_runtime_import.jl_Object, [org_teavm_runtime_import.otj_JSObject], 3, 3, 0, 0, 0,
