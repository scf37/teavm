...
j_TableImpl$Point__init__tkTdPD0 = (var_0, var_1, var_2) => {
    let var_3 = new j_TableImpl$Point();
    j_TableImpl$Point__init__tkTdPD(var_3, var_0, var_1, var_2);
    return var_3;
},
...
j_TableImpl_addCell_RzmAeX = ($this, $x, $y, $value) => {
    if ($x >= 0 && $y >= 0) {
        $this.$values.$put_lVIoyP(j_TableImpl$Point__init__tkTdPD0($this, $x, $y), $value);
        return;
    }
...
j_TableImpl_addRowHeader_nftnjR = ($this, $n, $value) => {
    $this.$values.$put_lVIoyP(j_TableImpl$Point__init__tkTdPD0($this, (-1), $n), $value);
},
j_TableImpl_addColumnHeader_nftnjR = ($this, $n, $value) => {
    $this.$values.$put_lVIoyP(j_TableImpl$Point__init__tkTdPD0($this, $n, (-1)), $value);
},
j_TableImpl_getTable = $this => {
    ...
    while ($y < var$6) {
        ...
        $x = (-1);
        while ($x < var$5) {
            $value = $this.$values.$getOrDefault_lVIoyP(j_TableImpl$Point__init__tkTdPD0($this, $x, $y), org_teavm_runtime_import.$rt_str("?"));
            if ($x == (-1) && $y == (-1))
...
org_teavm_runtime_import.$rt_metadata([j_TableImpl$Point, 0, org_teavm_runtime_import.jl_Object, [], 0, 0, 0, 0, [(o,r)=>o.$_init__tkTdPD=r, org_teavm_runtime_import.$rt_wrapFunction3(j_TableImpl$Point__init__tkTdPD), (o,r)=>o.$equals_yToRiJ=r, org_teavm_runtime_import.$rt_wrapFunction1(j_TableImpl$Point_equals_yToRiJ), (o,r)=>o.$hashCode=r, org_teavm_runtime_import.$rt_wrapFunction0(j_TableImpl$Point_hashCode)],
j_TableImpl, 0, org_teavm_runtime_import.jl_Object, [jst_Table_import.j_Table], 0, 0, 0, 0, [(o,r)=>o.$_init_=r, org_teavm_runtime_import.$rt_wrapFunction0(j_TableImpl__init_), (o,r)=>o.$addCell_RzmAeX=r, org_teavm_runtime_import.$rt_wrapFunction3(j_TableImpl_addCell_RzmAeX), (o,r)=>o.$addRowHeader_nftnjR=r, org_teavm_runtime_import.$rt_wrapFunction2(j_TableImpl_addRowHeader_nftnjR), (o,r)=>o.$addColumnHeader_nftnjR=r, org_teavm_runtime_import.$rt_wrapFunction2(j_TableImpl_addColumnHeader_nftnjR), (o,r)=>o.$getTable=r,
org_teavm_runtime_import.$rt_wrapFunction0(j_TableImpl_getTable)]]);
exports.j_TableImpl$Point__init__tkTdPD = j_TableImpl$Point__init__tkTdPD;
exports.j_TableImpl$Point__init__tkTdPD0 = j_TableImpl$Point__init__tkTdPD0;
